    ...
    <>
      ...
      >
        ...
        >
          ...
          <div>
            <a href="https://www.olx.com.pk/properties/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="97.25"
                height="33"
        ...
        <div className="d-flex align-items-center mt-3">
          <Row className="d-flex align-items-center w-100">
            ...
            <Col sm={24} md={12} lg={14} className="d-flex w-100">
        ...
        <div className="d-flex flex-column align-items-center">
          ...
          <div className="container d-flex flex-column align-items-center px-5">
            ...
            <div style={{ maxWidth: "275px" }}>
              <div className="d-flex align-items-center justify-content-center border border-3 border-dark rounded-1 py-2 px-3 w-100 mb-2">
                <img
